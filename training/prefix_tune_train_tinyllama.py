...
CONFIG = {
    ...
    # Output parameters
    "output_dir": "./prefix_tuned_tinyllama",
...
def train_model():
    ...
    peft_config = PrefixTuningConfig(
        ...
        num_virtual_tokens=CONFIG["num_virtual_tokens"],  # Same as prompt tuning
        prefix_projection=True,  # Enables MLP projection for better performance
        encoder_hidden_size=CONFIG.get("encoder_hidden_size", 512),  # Can tune based on model size
    )
