...
CONFIG = {
    ...
    # Output parameters
    "output_dir": "./IA3_tinyllama",
    "hub_model_id": "safffrron/prompt_tuning_IA3",
    "push_to_hub": True
}
...
def train_model():
    ...
    peft_config = IA3Config(
        ...
        target_modules=["k_proj", "v_proj", "down_proj"],  # Choose which layers to scale
        feedforward_modules=["down_proj"],  # FFN layers to scale
    )
